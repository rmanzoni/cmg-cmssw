...
variables = {
    ...
    'bdt_muon_dz': {'nbin':nbin, 'xtitle':'log(abs(dz))', 'xmin':-15, 'xmax':0},
    'bdt_muon_dxy': {'nbin':nbin, 'xtitle':'log(abs(dxy))', 'xmin':-15, 'xmax':0},
    ...
    'bdt_electron_dB3D': {'nbin':nbin, 'xtitle':'electron MVA dB3D (cm)', 'xmin':-0.05, 'xmax':0.05},
    'bdt_electron_dz': {'nbin':nbin, 'xtitle':'log(abs(dz))', 'xmin':-15, 'xmax':0},
    'bdt_electron_dxy': {'nbin':nbin, 'xtitle':'log(abs(dxy))', 'xmin':-15, 'xmax':0},
