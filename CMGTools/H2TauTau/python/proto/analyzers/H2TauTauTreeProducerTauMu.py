...
# htt_mt_globalVariables = htt_globalVariables            + \
#                          fillTau ('l1','diLepton.leg1()') + \
#                          fillMuon('l2','diLepton.leg2()') #+ \
#                          fillGenParticle('l1_gen','diLepton.leg1().genParticle()') + \
#                          fillGenParticle('l2_gen','diLepton.leg2().genParticle()') 

#                          fillGenParticle('l1_gen','diLepton.leg1().genParticle()', isTau = True, genVisTau = 'diLepton.leg1().physObj.genJet()') + \
#                          fillGenParticle('l2_gen','diLepton.leg2().genParticle()') 


htt_mt_globalVariables = fillTau ('l1','diLepton.leg1()') + \
                         fillMuon('l2','diLepton.leg2()') #+ \
                         
htt_mt_globalObjects = htt_globalObjects.copy() 
htt_mt_globalObjects.update( {} )

htt_mt_collections = htt_collections.copy()
htt_mt_collections.update( {} )
